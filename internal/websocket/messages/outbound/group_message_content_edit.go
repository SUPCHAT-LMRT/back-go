...
type OutboundGroupMessageContentEdited struct {
...
func (o *OutboundGroupMessageContentEdited) GetActionName() messages.Action {
	return messages.OutboundGroupMessageContentEditedAction
}

func (o *OutboundGroupMessageContentEdited) Encode() ([]byte, error) {
