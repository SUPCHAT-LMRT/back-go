...
func NewGetRolesForMemberUsecase(roleRepository repository.RoleRepository) *GetRolesForMemberUsecase {
	return &GetRolesForMemberUsecase{roleRepository: roleRepository}
}

func (u *GetRolesForMemberUsecase) Execute(ctx context.Context, workspaceId workspace_entity.WorkspaceId, workspaceMemberId entity2.WorkspaceMemberId) ([]*entity.Role, error) {
