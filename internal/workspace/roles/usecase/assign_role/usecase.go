...
func (u *AssignRoleToUserUsecase) Execute(ctx context.Context, workspaceMemberId entity2.WorkspaceMemberId, roleId entity.RoleId, workspaceId entity.WorkspaceId) error {
	err := u.roleRepository.AssignRoleToUser(ctx, workspaceMemberId, roleId, workspace_entity.WorkspaceId(workspaceId))
	if err != nil {
		return err
	}
