...
func NewDessassignRoleFromUserUsecase(roleRepository repository.RoleRepository) *DessassignRoleFromUserUsecase {
	return &DessassignRoleFromUserUsecase{roleRepository: roleRepository}
}

func (u *DessassignRoleFromUserUsecase) Execute(ctx context.Context, userId string, roleId string, workspaceId string) error {
