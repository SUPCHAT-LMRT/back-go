...
func NewListMessageUseCase(
	repository chat_message_repository.ChannelMessageRepository,
) *ListChannelMessagesUseCase {
	return &ListChannelMessagesUseCase{repository: repository}
}

func (u ListChannelMessagesUseCase) Execute(
	ctx context.Context,
	channelId entity.ChannelId,
	params QueryParams,
) ([]*chat_message_entity.ChannelMessage, error) {
	return u.repository.ListByChannelId(
		ctx,
		channelId,
		chat_message_repository.ListByChannelIdQueryParams{
			Limit:           params.Limit,
