...
func NewGetMinutelyMessageSentUseCase(repository repository.MessageSentTimeSeriesWorkspaceRepository) *GetMinutelyMessageSentUseCase {
	return &GetMinutelyMessageSentUseCase{repository: repository}
}

func (u *GetMinutelyMessageSentUseCase) Execute(ctx context.Context, workspaceId workspace_entity.WorkspaceId, from, to time.Time) ([]*entity.MessageSent, error) {
