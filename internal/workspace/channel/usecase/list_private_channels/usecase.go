...
func NewGetPrivateChannelsUseCase(repository repository.ChannelRepository) *GetPrivateChannelsUseCase {
	return &GetPrivateChannelsUseCase{repository: repository}
}

func (u *GetPrivateChannelsUseCase) Execute(ctx context.Context, workspaceId workspace_entity.WorkspaceId, userId string) ([]*entity.Channel, error) {
