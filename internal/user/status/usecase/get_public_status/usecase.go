...
func NewGetPublicStatusUseCase(useCase *get_or_create_status.GetOrCreateStatusUseCase) *GetPublicStatusUseCase {
	return &GetPublicStatusUseCase{useCase: useCase}
}

func (u *GetPublicStatusUseCase) Execute(ctx context.Context, userId user_entity.UserId, defaultStatus entity.Status) (entity.Status, error) {
