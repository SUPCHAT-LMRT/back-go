...
func (u ListDirectMessagesUseCase) Execute(ctx context.Context, user1Id, user2Id user_entity.UserId, params QueryParams) ([]*chat_direct_entity.ChatDirect, error) {
