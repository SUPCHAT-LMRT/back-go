...
func NewSaveGroupChatMessageUseCase(repository repository.GroupChatMessageRepository) *SaveGroupChatMessageUseCase {
	return &SaveGroupChatMessageUseCase{repository: repository}
}

func (u SaveGroupChatMessageUseCase) Execute(ctx context.Context, message *entity.GroupChatMessage) error {
